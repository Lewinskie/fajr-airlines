...
function HeroCarousel({ heroCarousel_data }) {
  ...
  return (
    <Swiper
      ...
      className="group  h-[55vh]  overflow-hidden "
    >
          ...
          >
            ...
            >
              <Image
                ...
                className={` -z-10 block h-auto w-full duration-700 ease-in-out  ${
            ...
            <div className="absolute bottom-0 left-0  h-full w-full flex flex-row justify-start">
              <div className="max-w-7xl mx-auto flex flex-col items-start justify-center w-3/5">
                <h1 className="text-4xl font-sans font-bold leading-noramal text-secondary-500 ">
                  {heroImage.short_title}
                </h1>
                <p className="text-lg text-secondary-200 font-serif mt-5 ">
                  {heroImage.long_title}
                </p>
                <div className="flex flex-row items-center justify-start space-x-10 text-primary-200">
                  <div className="my-4">{heroImage.hero_phrase}</div>
                </div>
              </div>
            </div>
          </SwiperSlide>
